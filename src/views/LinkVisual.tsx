    ...
    return (
        ...
        }
        {
            ...
            <g>{'<!--link.target && link.merge ╔ -->'}
                {  link.target.x !== link.source.x && <line strokeDasharray={link.source.commit.virtual || link.source.commit.isStash? '2' : 'none'} className="line" x1={link.source.x} y1={link.source.y} x2={(link.target.x || 0) - (10 * linkDirection)} y2={link.source.y}
                    style={{ stroke: link.color.stringValue }}></line> }
